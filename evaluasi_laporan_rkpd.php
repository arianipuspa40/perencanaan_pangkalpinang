		...
		rows:[
			{
				...
				elements:[
					{view:"label", template:
						...
						"<span class='webix_icon fa-angle-double-right'></span>LAPORAN EVALUASI RKPD"
					},
					//{width:1},
					{ view:"segmented", value:"EVALUASI_RKPD", width:500, 
						options:[
						{id:"EVALUASI_RKPD", value:"EVALUASI RKPD"},
						{id:"EVALUASI_RKPD_TAHUN_BERKENAAN", value:"EVALUASI RKPD TAHUN BERKENAAN"},
						//{id:"SASARAN PD", value:"SASARAN PD"}
						], click:function(id, e) {
							var id_opt = $$(id).getValue();
							if (id_opt=="EVALUASI_RKPD") {$$("IFRAME_CONTENT").load("evaluasi_laporan_rkpd_evaluasi_rkpd.php");}
							if (id_opt=="EVALUASI_RKPD_TAHUN_BERKENAAN") {$$("IFRAME_CONTENT").load("evaluasi_laporan_rkpd_evaluasi_rkpd_tahun_berkenaan.php");}
			...
			},
			{
				//type:"space",
				rows:[
					{view:"iframe", padding:0, id:"IFRAME_CONTENT", autoheight:true, adjust:true, scroll:"auto", src:"evaluasi_laporan_rkpd_evaluasi_rkpd.php"}
				]
			}
		]
	});
