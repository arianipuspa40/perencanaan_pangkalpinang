        ...
        rows: [{
            ...
            elements: [{
                ...
                template: "<span class='webix_icon fa-home' style='margin-left:6px;'></span> PERENCANAAN &nbsp;" +
                  "<span class='webix_icon fa-angle-double-right'></span>RPJMD EDIT"
              },
              //{width:1},
              {
                view: "segmented",
                ...
                click: function(id, e) {
                  ...
                  if (id_opt == "MURNI") {
                    $$("IFRAME_CONTENT").load("perencanaan_rpjmd_murni_edit.php");
                  }
                  if (id_opt == "PERUBAHAN") {
                    $$("IFRAME_CONTENT").load("perencanaan_rpjmd_murni.php");
                  }
                  //if (id_opt=="SASARAN DAERAH") {$$("IFRAME_CONTENT").load("sasaran_daerah.php");}
                }
              },
              {},
            ],
          },
          {
            ...
            rows: [{
              ...
              adjust: true,
              scroll: "auto",
              src: "perencanaan_rpjmd_murni_edit.php"
            }]
          }
        ]
      });
