			...
			elements:[
				{
					rows:[
						{
							cols:[
								{view:"checkbox", label:"NAMA OPD", id:"SASARAN_PD_CB", labelWidth:140, width:170, disabled:true},
								{view:"text", id:"SASARAN_PD_TXT", width:400, disabled:true}, {},
						...
						},
						{
							cols:[
								...
								{view:"text", id:"PAGU_TAHUN_3TXT", width:400,format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})}
							],
						},
						{
							cols:[
...
var nav_program = {
	...
	cols:[
		...
		// {view:"button", type:"iconButton", icon:"cog", label:"refresh", autowidth:true, click:"getData()"},
		// {view:"button", type:"iconButton", icon:"plus-circle", label:"TAMBAH", autowidth:true, click:"addData1()"},
		// {view:"button", type:"iconButton", icon:"edit", label:"EDIT", autowidth:true, click:"editData1()"},
...
var indikator_program = {
	...
	columns:[
		...
		{header:"KINERJA AWAL", 				id:"INDIPROG_KINERJA_AWAL_PROGRAM", 			width:150, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA AKHIR", 		id:"INDIPROG_TARGET_AKHIR_KINERJA_PROGRAM", 			width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},		
		{header:"TARGET KINERJA TAHUN 1", 		id:"INDIPROG_TARGET_KINERJA_PROG_TAHUN1", 				width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 2", 		id:"INDIPROG_TARGET_KINERJA_PROG_TAHUN2", 				width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 3", 		id:"INDIPROG_TARGET_KINERJA_PROG_TAHUN3", 				width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 4", 		id:"INDIPROG_TARGET_KINERJA_PROG_TAHUN4", 				width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 5", 		id:"INDIPROG_TARGET_KINERJA_PROG_TAHUN5", 				width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
...
var nav_kegiatan = {
	...
	cols:[
		...
		{view:"button", type:"iconButton", icon:"edit", label:"EDIT", autowidth:true, click:"editData2()"},
...
var nav_indikator_kegiatan = {
	...
	cols:[
		...
		{view:"button", type:"iconButton", icon:"edit", label:"EDIT", autowidth:true, click:"editData21()"},
...
var indikator_kegiatan = {
	...
	columns:[
		...
		{header:"KINERJA AWAL", 				id:"INDIKEG_KINERJA_AWAL_KEGIATAN", 			width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA AKHIR", 		id:"INDIKEG_TARGET_AKHIR_KINERJA_KEGIATAN", 	width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 1", 		id:"INDIKEG_TARGET_KINERJA_KEG_TAHUN1", 		width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 2", 		id:"INDIKEG_TARGET_KINERJA_KEG_TAHUN2",			width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 3", 		id:"INDIKEG_TARGET_KINERJA_KEG_TAHUN3",			width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 4", 		id:"INDIKEG_TARGET_KINERJA_KEG_TAHUN4",			width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 5", 		id:"INDIKEG_TARGET_KINERJA_KEG_TAHUN5",			width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
...
var nav_subkegiatan = {
	...
	cols:[
		...
		{view:"button", type:"iconButton", icon:"edit", label:"EDIT", autowidth:true, click:"editData3()"},
...
var nav_indikator_subkegiatan = {
	...
	cols:[
		...
		{view:"button", type:"iconButton", icon:"edit", label:"EDIT", autowidth:true, click:"editData31()"},
...
var indikator_subkegiatan = {
	...
	columns:[
		...
		{header:"KINERJA AWAL", 				id:"INDISUBKEG_KINERJA_AWAL_SUBKEGIATAN", 					width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA AKHIR", 		id:"INDISUBKEG_TARGET_AKHIR_KINERJA_SUBKEGIATAN", 			width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 1", 		id:"INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN1", 				width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 2", 		id:"INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN2", 				width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 3", 		id:"INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN3", 				width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 4", 		id:"INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN4", 				width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
		{header:"TARGET KINERJA TAHUN 5", 		id:"INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN5", 				width:200, 	css:{'text-align':'right'},format:webix.Number.numToStr({groupDelimiter:".", groupSize:3,decimalDelimiter:",",decimalSize:0})},
...
var FORM_DATA11_ADD = {
	...
	elements:[
		...
		{view:"combo",	label:"PILIH INDI PROG", id:"ADD_INDIPROG_INDIKATOR_PROGRAM1", name:"INDIPROG_INDIKATOR_PROGRAM1", labelWidth:180, options: [{id:"", value:""},]
		},
...
var FORM_DATA21_ADD = {
	...
	elements:[
		...
		{view:"combo", label:"KEG FULL", id:"ADD_INDIKEG_KEG_FULL", 	name:"INDIKEG_KEG_FULL" ,	labelWidth:180, option:[{id:"Admin", value:""},{id:"", value:""},],disabled:true, hidden:true},
		{view:"combo",	label:"PILIH INDI KEG", id:"ADD_INDIKEG_INDIKATOR_KEGIATAN1", name:"INDIKEG_INDIKATOR_KEGIATAN1", labelWidth:180, options: [{id:"", value:""},]
		},
...
var FORM_DATA11_EDIT = {
	...
	elements:[
		{view:"combo",	label:"PILIH INDI PROG", id:"INDIPROG_INDIKATOR_PROGRAM1", name:"INDIPROG_INDIKATOR_PROGRAM1", labelWidth:180, options: [{id:"", value:""},]
		},
		{view:"textarea", 	label:"INDIKATOR PROGRAM", id:"INDIPROG_INDIKATOR_PROGRAM", name:"INDIPROG_INDIKATOR_PROGRAM", labelWidth:180},
		{view:"text", label:"SATUAN INDIKATOR", id:"INDIPROG_SATUAN_INDIKATOR_PROGRAM", name:"INDIPROG_SATUAN_INDIKATOR_PROGRAM", labelWidth:180},
		{view:"text", label:"KINERJA AWAL", 	id:"INDIPROG_KINERJA_AWAL_PROGRAM", name:"INDIPROG_KINERJA_AWAL_PROGRAM", labelWidth:180},
		{view:"text", label:"TARGET KINERJA AKHIR", id:"INDIPROG_TARGET_AKHIR_KINERJA_PROGRAM", name:"INDIPROG_TARGET_AKHIR_KINERJA_PROGRAM",labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-1", id:"INDIPROG_TARGET_KINERJA_PROG_TAHUN1",name:"INDIPROG_TARGET_KINERJA_PROG_TAHUN1", labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-2", id:"INDIPROG_TARGET_KINERJA_PROG_TAHUN2",name:"INDIPROG_TARGET_KINERJA_PROG_TAHUN2", labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-3", id:"INDIPROG_TARGET_KINERJA_PROG_TAHUN3",name:"INDIPROG_TARGET_KINERJA_PROG_TAHUN3", labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-4", id:"INDIPROG_TARGET_KINERJA_PROG_TAHUN4",name:"INDIPROG_TARGET_KINERJA_PROG_TAHUN4", labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-5", id:"INDIPROG_TARGET_KINERJA_PROG_TAHUN5",name:"INDIPROG_TARGET_KINERJA_PROG_TAHUN5", labelWidth:180},
		{view:"textarea", 	label:"CATATAN REJECT",		 id:"INDIPROG_CATATAN_REJECT", name:"INDIPROG_CATATAN_REJECT",	labelWidth:180, disabled:true},
		{
			margin:5,
			cols:[
				{width:116},
...
var FORM_DATA2_EDIT = {
	...
	elements:[
		...
		{view:"textarea", label:"KEGIATAN", id:"KEG_DESKRIPSI", name:"KEG_DESKRIPSI", labelWidth:180},
		...
		{view:"textarea", 	label:"CATATAN REJECT",		id:"KEG_CATATAN_REJECT", name: "KEG_CATATAN_REJECT", labelWidth:180, disabled:true},
		{
			margin:5,
			cols:[
				{width:116},
				{view:"button", label:"Simpan", type:"form", align:"center", width:100, disabled:true, click:function(){
					// dataEdit();
					$$("WIN_DATA2_EDIT").hide();
				}},
				{view:"button", label:"Cancel", align:"center", width:100, click:function(){
...
var FORM_DATA21_EDIT = {
	...
	elements:[
		{view:"combo",	label:"PILIH INDI PROG", id:"INDIKEG_INDIKATOR_KEGIATAN1", name:"INDIKEG_INDIKATOR_KEGIATAN1", labelWidth:180, options: [{id:"", value:""},]
		},
		{view:"textarea", 	label:"INDIKATOR KEGIATAN", id:"INDIKEG_INDIKATOR_KEGIATAN", name:"INDIKEG_INDIKATOR_KEGIATAN", labelWidth:180},
		{view:"text", label:"SATUAN INDIKATOR", id:"INDIKEG_SATUAN_INDIKATOR_KEGIATAN", name:"INDIKEG_SATUAN_INDIKATOR_KEGIATAN", labelWidth:180},
		{view:"text", label:"KINERJA AWAL", 	id:"INDIKEG_KINERJA_AWAL_KEGIATAN", name:"INDIKEG_KINERJA_AWAL_KEGIATAN", labelWidth:180},
		{view:"text", label:"TARGET KINERJA AKHIR", id:"INDIKEG_TARGET_AKHIR_KINERJA_PROGRAM", name:"INDIKEG_TARGET_AKHIR_KINERJA_KEGIATAN",labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-1", id:"INDIKEG_TARGET_KINERJA_KEG_TAHUN1",name:"INDIKEG_TARGET_KINERJA_KEG_TAHUN1", labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-2", id:"INDIKEG_TARGET_KINERJA_KEG_TAHUN2",name:"INDIKEG_TARGET_KINERJA_KEG_TAHUN2", labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-3", id:"INDIKEG_TARGET_KINERJA_KEG_TAHUN3",name:"INDIKEG_TARGET_KINERJA_KEG_TAHUN3", labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-4", id:"INDIKEG_TARGET_KINERJA_KEG_TAHUN4",name:"INDIKEG_TARGET_KINERJA_KEG_TAHUN4", labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-5", id:"INDIKEG_TARGET_KINERJA_KEG_TAHUN5",name:"INDIKEG_TARGET_KINERJA_KEG_TAHUN5", labelWidth:180},
...
var FORM_DATA3_EDIT = {
	...
	elements:[
		...
		{view:"text", label:"PAGU TAHUN KE-1",id:"SUBKEG_TARGET_PAGU_SUBKEG_TAHUN1",name:"SUBKEG_TARGET_PAGU_SUBKEG_TAHUN1",labelWidth:180, disabled:false},
		{view:"text", label:"PAGU TAHUN KE-2",id:"SUBKEG_TARGET_PAGU_SUBKEG_TAHUN2",name:"SUBKEG_TARGET_PAGU_SUBKEG_TAHUN2",labelWidth:180, disabled:false},
		{view:"text", label:"PAGU TAHUN KE-3",id:"SUBKEG_TARGET_PAGU_SUBKEG_TAHUN3",name:"SUBKEG_TARGET_PAGU_SUBKEG_TAHUN3",labelWidth:180, disabled:false},
		{view:"text", label:"PAGU TAHUN KE-4",id:"SUBKEG_TARGET_PAGU_SUBKEG_TAHUN4",name:"SUBKEG_TARGET_PAGU_SUBKEG_TAHUN4",labelWidth:180, disabled:false},
		{view:"text", label:"PAGU TAHUN KE-5",iid:"SUBKEG_TARGET_PAGU_SUBKEG_TAHUN5",name:"SUBKEG_TARGET_PAGU_SUBKEG_TAHUN5",labelWidth:180, disabled:false},
...
var FORM_DATA31_EDIT = {
	...
	elements:[
		...
		// {view:"combo", label:"KEG FULL", id:"ADD_INDIKEG_KEG_FULL", 	name:"INDIKEG_KEG_FULL" ,	labelWidth:180, option:[{id:"Admin", value:""},{id:"", value:""},],disabled:true},
		{view:"textarea", 	label:"INDIKATOR SUB KEGIATAN", id:"EDIT_INDISUBKEG_INDIKATOR_SUBKEGIATAN", name:"INDISUBKEG_INDIKATOR_SUBKEGIATAN", labelWidth:180},
		{view:"text", label:"SATUAN INDIKATOR", id:"EDIT_INDISUBKEG_SATUAN_INDIKATOR_SUBKEGIATAN", name:"INDISUBKEG_SATUAN_INDIKATOR_SUBKEGIATAN", labelWidth:180},
		{view:"text", label:"KINERJA AWAL", 	id:"EDIT_INDISUBKEG_KINERJA_AWAL_SUBKEGIATAN", name:"INDISUBKEG_KINERJA_AWAL_SUBKEGIATAN", labelWidth:180},
		{view:"text", label:"TARGET KINERJA AKHIR", id:"EDIT_INDISUBKEG_TARGET_AKHIR_KINERJA_SUBKEGIATAN", name:"INDISUBKEG_TARGET_AKHIR_KINERJA_SUBKEGIATAN",labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-1", id:"EDIT_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN1",name:"INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN1", labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-2", id:"EDIT_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN2",name:"INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN2", labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-3", id:"EDIT_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN3",name:"INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN3", labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-4", id:"EDIT_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN4",name:"INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN4", labelWidth:180},
		{view:"text", label:"TARGET KINERJA TAHUN KE-5", id:"EDIT_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN5",name:"INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN5", labelWidth:180},
		{view:"textarea", 	label:"CATATAN REJECT",		 id:"EDIT_INDISUBKEG_CATATAN_REJECT", name:"INDISUBKEG_CATATAN_REJECT",	labelWidth:180, disabled:true},
		{
			margin:5,
			cols:[
				{width:116},
...
function dataEdit1(){
	...
	// console.log(param1)
	webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=program&action=edit",{param1:param1}, function(text, data){
		if (data.json().status=="success"){
...
function dataEditIndiProg(){
	...
	if  (validasiEditIndikatorProg()) {
		...
		// console.log(param1)
		webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=indiprog&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Data Berhasil Diedit.</div>"});
					// console.log("add program");
...
function dataEditIndiKeg(){
	...
	if  (validasiIndikatorKeg(param1)) {
		...
		// console.log(param1)
		webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=indikeg&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Data Berhasil Diedit.</div>"});
					// console.log("add program");
...
function dataEditSubKeg(){
	...
	if  (validasiSubKeg(param1)) {
		webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=subkeg&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Data Berhasil Diedit.</div>"});
					// console.log("add program");
...
function dataEditIndSubKeg(){
	...
	if  (validasiIndiSubKeg(param1)) {
		webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=indisubkeg&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Data Berhasil Diedit.</div>"});
					// console.log("add program");
	...
	if (webix.rules.isNotEmpty(param1.ROW_ID)){
		...
		webix.ajax().post("getStatus.php?lvl=program_renstra_murni&opd_id="+param1.OPD_ID, function(text, data){
			...
			if (data.json().status=="reject"){
				...
				webix.ajax().post("verifikasi.php?lvl=renstra_kabid&action=pengajuan",{param1:param1}, function(text, data){
					// console.log(data.json().status);
					if (data.json().status=="success"){
						webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Proses Pengajuan Berhasil.</div>"});
							// console.log("add program");
							// console.log(data.json().action);
							// console.log(data.json().sqltes);			
						getData();
