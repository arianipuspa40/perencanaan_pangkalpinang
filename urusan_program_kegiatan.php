	...
	rows:[
		{
			...
			elements:[
				{
					cols:[
						{view:"checkbox", label:"LEVEL", id:"USER_CB", labelWidth:140, width:170, click:"filterData()"},
						{view:"text", id:"USER_TXT", width:450}, {}
					],
				},
				{
					cols:[
						{view:"checkbox", label:"PROGRAM", id:"PEGAWAI_CB", labelWidth:140, width:170, click:"filterData()"},
						{view:"text", id:"PEGAWAI_TXT", width:450}, {}
					],
				},
				{	
					cols:[
						{view:"checkbox", label:"KEGIATAN", id:"OPD_CB", labelWidth:140, width:170, click:"filterData()"},
						{view:"text", id:"OPD_TXT", width:450}, {}, 
					],
				},
				{
					cols:[
						{view:"checkbox", label:"SUB KEGIATAN", id:"BIDANG_CB", labelWidth:140, width:170, click:"filterData()"},
						{view:"text", id:"BIDANG_TXT", width:450}, {}
					],
				},
				{
					cols:[
						{view:"checkbox", label:"DESKRIPSI", id:"BIDANG_CB", labelWidth:140, width:170, click:"filterData()"},
						{view:"text", id:"BIDANG_TXT", width:450}, {}
					],
				},
				{
					cols:[
						{view:"checkbox", label:"TAHUN", id:"BIDANG_CB", labelWidth:140, width:170, click:"filterData()"},
						{view:"text", id:"BIDANG_TXT", width:450}, {}
					],
				},
...
var nav_opd = {
	...
	cols:[
		{
			template:"<span class='webix_icon fa-table'></span>URUSAN, PROGRAM, KEGIATAN, SUB KEGIATAN",
			css:"sub_title2", borderless:true, 
		},
		{},
		{view:"button", type:"iconButton", icon:"plus-circle", label:"TAMBAH", autowidth:true, click:"addOpd()"},
		{view:"button", type:"iconButton", icon:"edit", label:"EDIT", autowidth:true, click:"editOpd()"},
		{view:"button", type:"iconButton", icon:"trash-o", label:"DELETE", autowidth:true, click:"deleteOpd()"},
	]
};
var opd = {
	view:"datatable", id:"DATATABLE_OPD", leftSplit:2, rightSplit:2,
	select:true, css:"datatable_column", height:300,
	columns:[
		{header:"#", 													id:"ROW_ID", 									hidden:true},
		
		{header:"NO", 												id:"NO", 											width:35, 	css:{'text-align':'right'}},
		{header:"URUSAN", 										id:"URUSAN_1", 								width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"BIDANG URUSAN", 							id:"BIDANG_URUSAN_1", 				width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"PROGRAM", 										id:"URUSAN_2", 								width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"KODE WILAYAH KEGIATAN", 			id:"BIDANG_URUSAN_2", 				width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"KEGIATAN", 									id:"BIDANG_URUSAN_2", 				width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"SUB KEGIATAN", 							id:"BIDANG_URUSAN_2", 				width:200, 	css:{'text-align':'left'}, fillspace:true},
		
		{header:"LEVEL", 											id:"URUSAN_3", 								width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"DESKRIPSI", 									id:"BIDANG_URUSAN_2", 				width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"TAHUN", 											id:"BIDANG_URUSAN_2", 				width:200, 	css:{'text-align':'left'}, fillspace:true},
	...
	rows:[
		{
			...
			elements:[
				{view:"label", template:
					...
					"<span class='webix_icon fa-angle-double-right'></span>URUSAN, PROGRAM, KEGIATAN, SUB KEGIATAN"
				},
			],
		},
		{
...
var FORM_OPD_ADD = {
	...
	elements:[
		{view:"text", 			label:"URUSAN",										id:"OPD_ADD_KODE_OPD_LENGKAP", 			labelWidth:180},
		{view:"text", 			label:"BIDANG URUSAN",						id:"OPD_ADD_DESKRIPSI_OPD", 				labelWidth:180},
		{view:"text", 			label:"PROGRAM", 									id:"OPD_ADD_URUSAN_1", 							labelWidth:180},
		{view:"text", 			label:"KODE WILAYAH KEGIATAN",		id:"OPD_ADD_BIDANG_URUSAN_1", 			labelWidth:180},
		{view:"text", 			label:"KEGIATAN", 								id:"OPD_ADD_URUSAN_2", 							labelWidth:180},
		{view:"text", 			label:"SUB KEGIATAN", 						id:"OPD_ADD_URUSAN_21", 						labelWidth:180},
		{view:"combo", 			label:"LEVEL", 										id:"OPD_ADD_BIDANG_URUSAN_2", 			labelWidth:180, options:[{id:"", value:""},]},
		{view:"text", 			label:"DESKRIPSI", 								id:"OPD_ADD_URUSAN_22", 						labelWidth:180},
		{view:"text", 			label:"TAHUN", 									 	id:"OPD_ADD_URUSAN_23", 						labelWidth:180},
		{view:"text", 			label:"DASAR HUKUM", 							id:"OPD_ADD_URUSAN_24", 						labelWidth:180},
		{
			margin:5,
			cols:[
				{},
...
var FORM_OPD_EDIT = {
	...
	elements:[
		{view:"text", 			label:"URUSAN",										id:"OPD_EDIT_KODE_OPD_LENGKAP", 			labelWidth:180},
		{view:"text", 			label:"BIDANG URUSAN",						id:"OPD_EDIT_DESKRIPSI_OPD", 				labelWidth:180},
		{view:"text", 			label:"PROGRAM", 									id:"OPD_EDIT_URUSAN_1", 							labelWidth:180},
		{view:"text", 			label:"KODE WILAYAH KEGIATAN",		id:"OPD_EDIT_BIDANG_URUSAN_1", 			labelWidth:180},
		{view:"text", 			label:"KEGIATAN", 								id:"OPD_EDIT_URUSAN_2", 							labelWidth:180},
		{view:"text", 			label:"SUB KEGIATAN", 						id:"OPD_EDIT_URUSAN_21", 						labelWidth:180},
		{view:"combo", 			label:"LEVEL", 										id:"OPD_EDIT_BIDANG_URUSAN_2", 			labelWidth:180, options:[{id:"", value:""},]},
		{view:"text", 			label:"DESKRIPSI", 								id:"OPD_EDIT_URUSAN_22", 						labelWidth:180},
		{view:"text", 			label:"TAHUN", 									 	id:"OPD_EDIT_URUSAN_23", 						labelWidth:180},
		{view:"text", 			label:"DASAR HUKUM", 							id:"OPD_EDIT_URUSAN_24", 						labelWidth:180},
		{
			margin:5,
			cols:[
				{},
...
webix.ready(function(){
	webix.ui({
		...
		head:{
			view:"toolbar", margin:-5, cols:[
				{view:"label", label:"<span class='webix_icon fa-trash-o'></span>HAPUS"},
...
var FORM_OPD_DELETE = {
	...
	elements:[
		{view:"text", 			label:"URUSAN",										id:"OPD_DELETE_KODE_OPD_LENGKAP", 			labelWidth:180},
		{view:"text", 			label:"BIDANG URUSAN",						id:"OPD_DELETE_DESKRIPSI_OPD", 				labelWidth:180},
		{view:"text", 			label:"PROGRAM", 									id:"OPD_DELETE_URUSAN_1", 							labelWidth:180},
		{view:"text", 			label:"KODE WILAYAH KEGIATAN",		id:"OPD_DELETE_BIDANG_URUSAN_1", 			labelWidth:180},
		{view:"text", 			label:"KEGIATAN", 								id:"OPD_DELETE_URUSAN_2", 							labelWidth:180},
		{view:"text", 			label:"SUB KEGIATAN", 						id:"OPD_DELETE_URUSAN_21", 						labelWidth:180},
		{view:"combo", 			label:"LEVEL", 										id:"OPD_DELETE_BIDANG_URUSAN_2", 			labelWidth:180, options:[{id:"", value:""},]},
		{view:"text", 			label:"DESKRIPSI", 								id:"OPD_DELETE_URUSAN_22", 						labelWidth:180},
		{view:"text", 			label:"TAHUN", 									 	id:"OPD_DELETE_URUSAN_23", 						labelWidth:180},
		{view:"text", 			label:"DASAR HUKUM", 							id:"OPD_DELETE_URUSAN_24", 						labelWidth:180},
		{
			margin:5,
			cols:[
				{},
