		...
		rows:[
			{
				...
				elements:[
					{view:"label", template:
						...
						"<span class='webix_icon fa-angle-double-right'></span>PERSETUJUAN PIMPINAN"
					},
					//{width:1},
					{ view:"segmented", value:"TRIWULAN_1", width:500, 
						...
						//{id:"SASARAN PD", value:"SASARAN PD"}
							...
							if (id_opt=="TRIWULAN_1") {$$("IFRAME_CONTENT").load("evaluasi_realisasi_pimpinan_t1.php");}
							if (id_opt=="TRIWULAN_2") {$$("IFRAME_CONTENT").load("evaluasi_realisasi_pimpinan_t2.php");}
							if (id_opt=="TRIWULAN_3") {$$("IFRAME_CONTENT").load("evaluasi_realisasi_pimpinan_t3.php");}
							if (id_opt=="TRIWULAN_4") {$$("IFRAME_CONTENT").load("evaluasi_realisasi_pimpinan_t4.php");}
			...
			},
			{
				//type:"space",
				rows:[
					{view:"iframe", padding:0, id:"IFRAME_CONTENT", autoheight:true, adjust:true, scroll:"auto", src:"evaluasi_realisasi_pimpinan_t1.php"}
				]
			}
		]
	});
