...
var ui = {
	...
	body:{
		...
		rows:[
			...
			{cols:[
				{},
				{view:"button", 	label:"APPROVE (finish)", type:"form", align:"center", width:150, height:40, click:"approve()"},
				{width:20},
...
function dataEdit1(){
	...
	if (webix.rules.isNotEmpty (param1.ROW_ID)){
		webix.ajax().post("perencanaan_renstra_entri_murni_tambah_catatan_bidang_teknis_murni.php?lvl=program&action=edit",{param1:param1}, function(text, data){
			if (data.json().status=="success"){
...
function dataEditIndiProg(){
	...
	if (webix.rules.isNotEmpty (param1.INDIPROG_ROW_ID)){
		webix.ajax().post("perencanaan_renstra_entri_murni_tambah_catatan_bidang_teknis_murni.php?lvl=indiprog&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Tambah Catatan Berhasil</div>"});
					// console.log("add program");
...
function dataEditKeg(){
	...
	if (webix.rules.isNotEmpty (param1.KEG_ROW_ID )){
		webix.ajax().post("perencanaan_renstra_entri_murni_tambah_catatan_bidang_teknis_murni.php?lvl=kegiatan&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Tambah Catatan Berhasil.</div>"});
					// console.log("add program");
...
function dataEditIndiKeg(){
	...
	if (webix.rules.isNotEmpty (param1.INDIKEG_ROW_ID )){	
		// console.log(param1)
		webix.ajax().post("perencanaan_renstra_entri_murni_tambah_catatan_bidang_teknis_murni.php?lvl=indikeg&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Tambah Catatan Berhasil.</div>"});
					// console.log("add program");
...
function dataEditSubKeg(){
	...
	if (webix.rules.isNotEmpty (param1.SUBKEG_ROW_ID )){
		webix.ajax().post("perencanaan_renstra_entri_murni_tambah_catatan_bidang_teknis_murni.php?lvl=subkeg&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Tambah Catatan Berhasil.</div>"});
					// console.log("add program");
...
function dataEditIndSubKeg(){
	...
	if (webix.rules.isNotEmpty (param1.INDISUBKEG_ROW_ID )){
		webix.ajax().post("perencanaan_renstra_entri_murni_tambah_catatan_bidang_teknis_murni.php?lvl=indisubkeg&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Tambah Catatan Berhasil</div>"});
					// console.log("add program");
...
function approve(){
	...
	if (webix.rules.isNotEmpty(param1.ROW_ID)){
		webix.ajax().post("getStatus.php?lvl=program_renstra_murni&opd_id="+param1.OPD_ID, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="verify"){

				webix.ajax().post("verifikasi.php?lvl=renstra_bidang_teknis&action=approve",{param1:param1}, function(text, data){
					// console.log(data.json().status);
					if (data.json().status=="success"){
						...
						webix.alert({
							type:"alert-error",
							title: "INFORMATION",
							text:"Proses Approve Gagal !! Karena Status "+data.json().status,
							ok:"OK",
							callback:function(){
								// $$("WIN_DATA11_ADD").hide();
							}
	...
	if (webix.rules.isNotEmpty(param1.ROW_ID)){
		webix.ajax().post("getStatus.php?lvl=program_renstra_murni&opd_id="+param1.OPD_ID, function(text, data){
			...
			if (data.json().status=="verify"){
				...
				webix.ajax().post("verifikasi.php?lvl=renstra_bidang_teknis&action=reject",{param1:param1}, function(text, data){
					// console.log(data.json().status);
					if (data.json().status=="success"){
						...
						webix.alert({
							type:"alert-error",
							title: "INFORMATION",
							text:"Proses Reject Gagal !!"+data.json().status,
							ok:"OK",
							callback:function(){
								// $$("WIN_DATA11_ADD").hide();
							}
