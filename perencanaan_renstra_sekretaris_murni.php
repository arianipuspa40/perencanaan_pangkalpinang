...
var ui = {
	...
	body:{
		...
		rows:[
			...
			{cols:[
				{},
				{view:"button", 	label:"APPROVE (verify)", type:"form", align:"center", width:150, height:40, click:"approve()"},
				{width:20},
...
function dataEdit1(){
	...
	if (webix.rules.isNotEmpty (param1.ROW_ID)){
		webix.ajax().post("perencanaan_renstra_entri_murni_tambah_catatan_sekretaris_murni.php?lvl=program&action=edit",{param1:param1}, function(text, data){
			if (data.json().status=="success"){
...
function dataEditIndiProg(){
	...
	if (webix.rules.isNotEmpty (param1.INDIPROG_ROW_ID)){
		webix.ajax().post("perencanaan_renstra_entri_murni_tambah_catatan_sekretaris_murni.php?lvl=indiprog&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Tambah Catatan Berhasil</div>"});
					// console.log("add program");
...
function dataEditKeg(){
	...
	if (webix.rules.isNotEmpty (param1.KEG_ROW_ID )){
		webix.ajax().post("perencanaan_renstra_entri_murni_tambah_catatan_sekretaris_murni.php?lvl=kegiatan&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Tambah Catatan Berhasil.</div>"});
					// console.log("add program");
...
function dataEditIndiKeg(){
	...
	if (webix.rules.isNotEmpty (param1.INDIKEG_ROW_ID )){	
		// console.log(param1)
		webix.ajax().post("perencanaan_renstra_entri_murni_tambah_catatan_sekretaris_murni.php?lvl=indikeg&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Tambah Catatan Berhasil.</div>"});
					// console.log("add program");
...
function dataEditSubKeg(){
	...
	if (webix.rules.isNotEmpty (param1.SUBKEG_ROW_ID )){
		webix.ajax().post("perencanaan_renstra_entri_murni_tambah_catatan_sekretaris_murni.php?lvl=subkeg&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Tambah Catatan Berhasil.</div>"});
					// console.log("add program");
...
function dataEditIndSubKeg(){
	...
	if (webix.rules.isNotEmpty (param1.INDISUBKEG_ROW_ID )){
		webix.ajax().post("perencanaan_renstra_entri_murni_tambah_catatan_sekretaris_murni.php?lvl=indisubkeg&action=edit",{param1:param1}, function(text, data){
			// console.log(data.json().status);
			if (data.json().status=="success"){
				webix.message({type:"form", text:"<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Tambah Catatan Berhasil</div>"});
					// console.log("add program");
	...
	if (webix.rules.isNotEmpty(param1.ROW_ID)){
		webix.ajax().post("getStatus.php?lvl=program_renstra_murni&opd_id="+param1.OPD_ID, function(text, data){
			...
			if (data.json().status=="request"){
				...
				webix.ajax().post("verifikasi.php?lvl=renstra_sekretaris&action=approve",{param1:param1}, function(text, data){
					// console.log(data.json().status);
					if (data.json().status=="success"){
	...
	if (webix.rules.isNotEmpty(param1.ROW_ID)){
		webix.ajax().post("getStatus.php?lvl=program_renstra_murni&opd_id="+param1.OPD_ID, function(text, data){
			...
			if (data.json().status=="request"){
				...
				webix.ajax().post("verifikasi.php?lvl=renstra_sekretaris&action=reject",{param1:param1}, function(text, data){
					// console.log(data.json().status);
					if (data.json().status=="success"){
