	...
	rows:[
		{
			...
			elements:[
				{
					cols:[
						{view:"checkbox", label:"NIP", id:"USER_CB", labelWidth:140, width:170, click:"filterData()"},
						{view:"text", id:"USER_TXT", width:450}, {}
					],
				},
				{
					cols:[
						{view:"checkbox", label:"NAMA", id:"PEGAWAI_CB", labelWidth:140, width:170, click:"filterData()"},
				...
				{
					cols:[
						{view:"checkbox", label:"BIDANG", id:"BIDANG_CB", labelWidth:140, width:170, click:"filterData()"},
...
var nav_opd = {
	...
	cols:[
		{
			template:"<span class='webix_icon fa-table'></span>PEGAWAI",
...
var opd = {
	...
	columns:[
		...
		{header:"NAMA", 											id:"URUSAN_1", 								width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"GELAR DEPAN", 								id:"BIDANG_URUSAN_1", 				width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"GELAR BELAKANG", 						id:"URUSAN_2", 								width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"NIP", 												id:"BIDANG_URUSAN_2", 				width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"GOLONGAN", 									id:"BIDANG_URUSAN_2", 				width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"JABATAN", 										id:"BIDANG_URUSAN_2", 				width:200, 	css:{'text-align':'left'}, fillspace:true},
		
		{header:"OPD", 												id:"URUSAN_3", 								width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"SUB OPD", 										id:"BIDANG_URUSAN_3", 				width:200, 	css:{'text-align':'left'}, fillspace:true},
		{header:"BIDANG", 										id:"URUTAN_OPD", 							width:100, 	css:{'text-align':'left'}, fillspace:true},
	...
	rows:[
		{
			...
			elements:[
				{view:"label", template:
					...
					"<span class='webix_icon fa-angle-double-right'></span>PEGAWAI"
				},
			],
		},
		{
	...
	webix.ui({
		...
		head:{
			view:"toolbar", margin:-5, cols:[
				{view:"label", label:"<span class='webix_icon fa-plus-circle'></span>TAMBAH PEGAWAI"},
...
var FORM_OPD_ADD = {
	...
	elements:[
		{view:"text", 			label:"NAMA",											id:"OPD_ADD_KODE_OPD_LENGKAP", 			labelWidth:180},
		{view:"text", 			label:"GELAR DEPAN",							id:"OPD_ADD_DESKRIPSI_OPD", 				labelWidth:180},
		{view:"text", 			label:"GELAR BELAKANG", 					id:"OPD_ADD_URUSAN_1", 							labelWidth:180},
		{view:"text", 			label:"NIP",											id:"OPD_ADD_BIDANG_URUSAN_1", 			labelWidth:180},
		{view:"text", 			label:"GOLONGAN", 								id:"OPD_ADD_URUSAN_2", 							labelWidth:180},
		{view:"text", 			label:"JABATAN", 									id:"OPD_ADD_URUSAN_21", 						labelWidth:180},
...
webix.ready(function(){
	webix.ui({
		...
		head:{
			view:"toolbar", margin:-5, cols:[
				{view:"label", label:"<span class='webix_icon fa-edit'></span>EDIT PEGAWAI"},
...
var FORM_OPD_EDIT = {
	...
	elements:[
		{view:"text", 			label:"NAMA",											id:"OPD_EDIT_KODE_OPD_LENGKAP", 			labelWidth:180},
		{view:"text", 			label:"GELAR DEPAN",							id:"OPD_EDIT_DESKRIPSI_OPD", 				labelWidth:180},
		{view:"text", 			label:"GELAR BELAKANG", 					id:"OPD_EDIT_URUSAN_1", 							labelWidth:180},
		{view:"text", 			label:"NIP",											id:"OPD_EDIT_BIDANG_URUSAN_1", 			labelWidth:180},
		{view:"text", 			label:"GOLONGAN", 								id:"OPD_EDIT_URUSAN_2", 							labelWidth:180},
		{view:"text", 			label:"JABATAN", 									id:"OPD_EDIT_URUSAN_21", 						labelWidth:180},
...
webix.ready(function(){
	webix.ui({
		...
		head:{
			view:"toolbar", margin:-5, cols:[
				{view:"label", label:"<span class='webix_icon fa-trash-o'></span>HAPUS PEGAWAI"},
...
var FORM_OPD_DELETE = {
	...
	elements:[
		{view:"text", 			label:"NAMA",											id:"OPD_DELETE_KODE_OPD_LENGKAP", 			labelWidth:180},
		{view:"text", 			label:"GELAR DEPAN",							id:"OPD_DELETE_DESKRIPSI_OPD", 				labelWidth:180},
		{view:"text", 			label:"GELAR BELAKANG", 					id:"OPD_DELETE_URUSAN_1", 							labelWidth:180},
		{view:"text", 			label:"NIP",											id:"OPD_DELETE_BIDANG_URUSAN_1", 			labelWidth:180},
		{view:"text", 			label:"GOLONGAN", 								id:"OPD_DELETE_URUSAN_2", 							labelWidth:180},
		{view:"text", 			label:"JABATAN", 									id:"OPD_DELETE_URUSAN_21", 						labelWidth:180},
