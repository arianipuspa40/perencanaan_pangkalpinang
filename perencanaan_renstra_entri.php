				...
				rows: [{
						...
						elements: [{
								...
								template: "<span class='webix_icon fa-home' style='margin-left:6px;'></span> PERENCANAAN &nbsp;" +
									...
									"<span class='webix_icon fa-angle-double-right'></span>ENTRI"
							},
							//{width:1},
							{
								view: "segmented",
								...
								click: function(id, e) {
									...
									if (id_opt == "MURNI") {
										$$("IFRAME_CONTENT").load("perencanaan_renstra_entri_murni1.php");
									}

									// dikasih x biar tidak aktif dahulu
									if (id_opt == "PERUBAHANx") {
										$$("IFRAME_CONTENT").load("perencanaan_renstra_entri_perubahan.php");
									}
					...
					},
					{
						...
						rows: [{
							...
							adjust: true,
							scroll: "auto",
							src: "perencanaan_renstra_entri_murni1.php"
						}]
					}
				]
			});
