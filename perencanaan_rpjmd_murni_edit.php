...
<head>
  ...
  <link rel="icon" type="image/vnd.microsoft.icon" href="img/logo_36kutai.png" />
  <link rel="shortcut icon" type="image/x-icon" href="img/logo_36kutai.png" />
  <title>:: PERENCANAAN - KABUPATEN KUTAI KARTANEGARA ::</title>
  ...
  <script type="text/javascript">
      ...
      on: {
        ...
        "onAfterSelect": function(id) {
          ...
          if (item) {
            ...
            // console.log(item);	
            $$('SASARAN_PD_TXT').setValue(item.NAMA_OPD);
    ...
    var nav_indikator_program = {
      ...
      cols: [{
        ...
        // {view:"button", type:"iconButton", icon:"edit", label:"EDIT", autowidth:true, click:"editData11()"},
    ...
    var FORM_DATA1_DELETE = {
      ...
      elements: [
        ...
        // {view:"text", 			label:"TOTAL PAGU AKHIR PERIODE",	id:"DELETE_ARGET_AKHIR_PAGU_PROGRAMU", 				labelWidth:180},
        {
          view: "text",
          label: "PAGU TAHUN KE-1",
          id: "DELETE_ARGET_PAGU_PROG_TAHUN1",
          name: "TARGET_PAGU_PROG_TAHUN1",
          labelWidth: 180
        },
        {
    ...
    function dataAddprog() {
      ...
      // console.log(param1)
      webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=program&action=add&lane=rpjmd", {
        param1: param1
      }, function(text, data) {
        console.log(data.json().status);
    ...
    function dataEdit1() {
      ...
      // console.log(param1)
      webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=program&action=edit&lane=rpjmd", {
        param1: param1
      }, function(text, data) {
        // console.log(data.json().status);
        if (data.json().status == "success") {
