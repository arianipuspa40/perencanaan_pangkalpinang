...
<head>
  ...
  <!-- <script src="https://kit.fontawesome.com/a29f0befba.js" crossorigin="anonymous"></script> -->
</head>
...
<body>
  ...
  <?php
  // var_dump(include('combo_sasaran_daerah.php'));
  // echo '<br>';
  // var_dump(include('combo_tujuan_pd.php'));
  // echo '<br>';
  // var_dump(include('combo_sasaran_pd.php'));
  // echo '<br>';
  // var_dump(include('combo_bidang_opd.php'));
  // echo '<br>';
  // var_dump(include('combo_program.php'));
  // echo '<br>';
  // var_dump(include('perencanaan_renstra_entri_murni_data.php'));
  ...
  <script type="text/javascript">
    ...
    // console.log(combo_sasaran_daerah);
    // console.log(combo_tujuan_pd);
    // console.log(combo_sasaran_pd);
    // console.log(combo_bidang_opd);
        ...
        elements: [{
          rows: [{
            ...
            },
            {
              cols: [{
                  view: "checkbox",
                  label: "STATUS RENSTRA",
                  id: "STATUS_RENSTRA_CB",
                  labelWidth: 140,
                  width: 170,
                  click: "filterData()"
                },
    ...
    var program = {
      ...
      columns: [{
        ...
        {
          header: "TARGET AKHIR PAGU",
          id: "TARGET_AKHIR_PAGU_PROGRAM",
          width: 150,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "PAGU TAHUN KE-1",
          id: "TARGET_PAGU_PROG_TAHUN1",
          width: 150,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "PAGU TAHUN KE-2",
          id: "TARGET_PAGU_PROG_TAHUN2",
          width: 150,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "PAGU TAHUN KE-3",
          id: "TARGET_PAGU_PROG_TAHUN3",
          width: 150,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "PAGU TAHUN KE-4",
          id: "TARGET_PAGU_PROG_TAHUN4",
          width: 150,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "PAGU TAHUN KE-5",
          id: "TARGET_PAGU_PROG_TAHUN5",
          width: 150,
          css: {
            'text-align': 'right'
          },
      ...
      on: {
        ...
        "onAfterSelect": function(id) {
          ...
          // cek apakah ada data? kl kosong tidak diberusaha menampilkan (menghidari error)
          if (item) {
            ...
            $$("DT_INDI_PROG").load(function() {
              return webix.ajax().post("perencanaan_renstra_entri_murni_data_child.php?lvl=indiprog", {
                rowid: prg_rowid
              }, function(text, data) {
            ...
            $$("DT_KEG").load(function() {
              return webix.ajax().post("perencanaan_renstra_entri_murni_data_child.php?lvl=kegiatan", {
                rowid: prg_rowid
              }, function(text, data) {
    ...
    var indikator_program = {
      ...
      columns: [{
        ...
        {
          header: "SATUAN INDIKATOR",
          id: "INDIPROG_SATUAN_INDIKATOR_PROGRAM",
          width: 200,
          css: {
            'text-align': 'left'
          }
        ...
        {
          header: "KINERJA AWAL",
          id: "INDIPROG_KINERJA_AWAL_PROGRAM",
          width: 150,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA AKHIR",
          id: "INDIPROG_TARGET_AKHIR_KINERJA_PROGRAM",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 1",
          id: "INDIPROG_TARGET_KINERJA_PROG_TAHUN1",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 2",
          id: "INDIPROG_TARGET_KINERJA_PROG_TAHUN2",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 3",
          id: "INDIPROG_TARGET_KINERJA_PROG_TAHUN3",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 4",
          id: "INDIPROG_TARGET_KINERJA_PROG_TAHUN4",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 5",
          id: "INDIPROG_TARGET_KINERJA_PROG_TAHUN5",
          width: 200,
          css: {
            'text-align': 'right'
          },
    ...
    var kegiatan = {
      ...
      columns: [{
        ...
        {
          header: "TARGET AKHIR PAGU",
          id: "KEG_TARGET_AKHIR_PAGU_KEGIATAN",
          width: 110,
          css: {
            'text-align': 'right'
          },
      ...
      on: {
        ...
        "onAfterSelect": function(id) {
          ...
          $$("DT_INDI_KEG").load(function() {
            return webix.ajax().post("perencanaan_renstra_entri_murni_data_child.php?lvl=indikeg", {
              rowid: keg_rowid
            }, function(text, data) {
              // console.log(data.json().numrows);
            })
          ...
          $$("DT_SUBKEG").load(function() {
            return webix.ajax().post("perencanaan_renstra_entri_murni_data_child.php?lvl=subkegiatan", {
              rowid: keg_rowid
            }, function(text, data) {
              // console.log(data.json().lvl);
            })
    ...
    var indikator_kegiatan = {
      ...
      columns: [{
        ...
        {
          header: "INDIKATOR KEGIATAN",
          id: "INDIKEG_INDIKATOR_KEGIATAN",
          width: 400,
          css: {
            'text-align': 'left'
          }
        ...
        {
          header: "SATUAN INDIKATOR",
          id: "INDIKEG_SATUAN_INDIKATOR_KEGIATAN",
          width: 215,
          css: {
            'text-align': 'left'
          }
        ...
        {
          header: "KINERJA AWAL",
          id: "INDIKEG_KINERJA_AWAL_KEGIATAN",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA AKHIR",
          id: "INDIKEG_TARGET_AKHIR_KINERJA_KEGIATAN",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 1",
          id: "INDIKEG_TARGET_KINERJA_KEG_TAHUN1",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 2",
          id: "INDIKEG_TARGET_KINERJA_KEG_TAHUN2",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 3",
          id: "INDIKEG_TARGET_KINERJA_KEG_TAHUN3",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 4",
          id: "INDIKEG_TARGET_KINERJA_KEG_TAHUN4",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 5",
          id: "INDIKEG_TARGET_KINERJA_KEG_TAHUN5",
          width: 200,
          css: {
            'text-align': 'right'
          },
    ...
    var subkegiatan = {
      ...
      columns: [{
        ...
        {
          header: "TARGET AKHIR PAGU",
          id: "SUBKEG_TARGET_AKHIR_PAGU_SUBKEGIATAN",
          width: 120,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "PAGU TAHUN KE-1",
          id: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN1",
          width: 150,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "PAGU TAHUN KE-2",
          id: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN2",
          width: 150,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "PAGU TAHUN KE-3",
          id: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN3",
          width: 150,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "PAGU TAHUN KE-4",
          id: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN4",
          width: 150,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "PAGU TAHUN KE-5",
          id: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN5",
          width: 150,
          css: {
            'text-align': 'right'
          },
      ...
      on: {
        ...
        "onAfterSelect": function(id) {
          ...
          $$("DT_INDI_SUB_KEG").load(function() {
            return webix.ajax().post("perencanaan_renstra_entri_murni_data_child.php?lvl=indisubkeg", {
              rowid: subkeg_rowid
            }, function(text, data) {
              // console.log(data.json().status);
            })
    ...
    var indikator_subkegiatan = {
      ...
      columns: [{
        ...
        {
          header: "INDIKATOR SUB KEGIATAN",
          id: "INDISUBKEG_INDIKATOR_SUBKEGIATAN",
          width: 400,
          css: {
            'text-align': 'left'
          }
        ...
        {
          header: "SATUAN INDIKATOR",
          id: "INDISUBKEG_SATUAN_INDIKATOR_SUBKEGIATAN",
          width: 220,
          css: {
            'text-align': 'left'
          }
        ...
        {
          header: "KINERJA AWAL",
          id: "INDISUBKEG_KINERJA_AWAL_SUBKEGIATAN",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA AKHIR",
          id: "INDISUBKEG_TARGET_AKHIR_KINERJA_SUBKEGIATAN",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 1",
          id: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN1",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 2",
          id: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN2",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 3",
          id: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN3",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 4",
          id: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN4",
          width: 200,
          css: {
            'text-align': 'right'
          },
        ...
        {
          header: "TARGET KINERJA TAHUN 5",
          id: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN5",
          width: 200,
          css: {
            'text-align': 'right'
          },
    ...
    var ui = {
      ...
      body: {
        ...
        rows: [{
          ...
          {
            cols: [{},
              // {view:"button", 	label:"PENGAJUAN", type:"form", align:"center", width:150, height:40, click:"pengajuan()"},
              {}
            ]
          },
          {
          ...
          onShow: function(id) {
            ...
            if (id_opd > 0) {
              ...
              $$('FORM_PROGRAM_ADD1').setValues({
                ...
                TARGET_PAGU_PROG_TAHUN1: "0",
                TARGET_PAGU_PROG_TAHUN2: "0",
                TARGET_PAGU_PROG_TAHUN3: "0",
                TARGET_PAGU_PROG_TAHUN4: "0",
                TARGET_PAGU_PROG_TAHUN5: "0",
                // field_b: "New York"
              });
      ...
      webix.ui({
        ...
        on: {
          onShow: function(id) {
            ...
            // console.log(item);
            if (id_opd > 0) {
              webix.ajax().post("combo_indikator.php?prgfull=" + item.PRG_FULL, function(text, data) {
                // console.log(data.json());
                if (data.json().status == "bermasalah") {
                  window.top.location.href = "index.php";
                }
                $$("ADD_INDIPROG_INDIKATOR_PROGRAM1").define("options", data.json());
                $$("ADD_INDIPROG_INDIKATOR_PROGRAM1").refresh();
              });
              // setting data awal program
      ...
      webix.ui({
        ...
        on: {
          onShow: function(id) {
            ...
            if (id_opd > 0) {
              // set data option combo kegiatan
      ...
      webix.ui({
        ...
        on: {
          onShow: function(id) {
            ...
            if (id_keg > 0) {
              webix.ajax().post("combo_indikator.php?prgfull=" + item.KEG_PRG_FULL, function(text, data) {
                // console.log(data.json());
                if (data.json().status == "bermasalah") {
                  window.top.location.href = "index.php";
                }
                $$("ADD_INDIKEG_INDIKATOR_KEGIATAN1").define("options", data.json());
                $$("ADD_INDIKEG_INDIKATOR_KEGIATAN1").refresh();
              });
          ...
          onShow: function(id) {
            ...
            if (id_opd > 0) {
              webix.ajax().post("combo_indikator.php?prgfull=" + item.PRG_FULL, function(text, data) {
                ...
                $$("INDIPROG_INDIKATOR_PROGRAM1").define("options", data.json());
                $$("INDIPROG_INDIKATOR_PROGRAM1").refresh();
              });
            }
          }
        }
          ...
          onShow: function(id) {
            ...
            if (id_keg > 0) {
              webix.ajax().post("combo_indikator.php?prgfull=" + item.KEG_PRG_FULL, function(text, data) {
                ...
                $$("INDIKEG_INDIKATOR_KEGIATAN1").define("options", data.json());
                $$("INDIKEG_INDIKATOR_KEGIATAN1").refresh();
              });
            }
          }
        }
    ...
    var FORM_DATA1_ADD = {
      ...
      elements: [
        ...
        {
          view: "combo",
          label: "SASARAN DAERAH",
          id: "ADD_SASARAN_DAERAH_ID",
          name: "SASARAN_DAERAH_ID",
          labelWidth: 180,
          options: combo_sasaran_daerah,
          disabled: true
        },
        {
          view: "text",
        ...
        },
        {
          view: "combo",
          label: "BIDANG OPD",
          id: "ADD_BIDANG_OPD_ID",
          name: "BIDANG_OPD_ID",
          labelWidth: 180,
          options: combo_bidang_opd
        },
        {
          view: "combo",
          ...
          name: "TUJUAN_PD_ID",
          labelWidth: 180,
          options: combo_tujuan_pd
        },
        {
          view: "combo",
          label: "SASARAN PERANGKAT DAERAH",
          id: "ADD_SASARAN_PD_ID",
          name: "SASARAN_PD_ID",
          labelWidth: 180,
          options: combo_sasaran_pd
        },

        {
          ...
          name: "PRG_FULL",
          labelWidth: 180,
          options: combo_program
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-1",
          id: "ADD_TARGET_PAGU_PROG_TAHUN1",
          name: "TARGET_PAGU_PROG_TAHUN1",
          labelWidth: 180,
          disabled: true
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-2",
          id: "ADD_TARGET_PAGU_PROG_TAHUN2",
          name: "TARGET_PAGU_PROG_TAHUN2",
          labelWidth: 180,
          disabled: true
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-3",
          id: "ADD_TARGET_PAGU_PROG_TAHUN3",
          name: "TARGET_PAGU_PROG_TAHUN3",
          labelWidth: 180,
          disabled: true
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-4",
          id: "ADD_TARGET_PAGU_PROG_TAHUN4",
          name: "TARGET_PAGU_PROG_TAHUN4",
          labelWidth: 180,
          disabled: true
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-5",
          id: "ADD_TARGET_PAGU_PROG_TAHUN5",
          name: "TARGET_PAGU_PROG_TAHUN5",
          labelWidth: 180,
          disabled: true
        },
    ...
    var FORM_DATA11_ADD = {
      ...
      elements: [{
          view: "text",
          label: "PRTID",
          id: "ADD_INDIPROG_PRT_ID",
          name: "INDIPROG_PRT_ID",
          hidden: true,
          labelWidth: 180
        },
        {
          view: "text",
          label: "OPD",
          id: "ADD_INDIPROG_OPD_ID",
          name: "INDIPROG_OPD_ID",
          hidden: true,
          labelWidth: 180
        },
        {
          view: "text",
          label: "SUB OPD",
          id: "ADD_INDIPROG_SUB_OPD_ID",
          name: "INDIPROG_SUB_OPD_ID",
          hidden: true,
          labelWidth: 180
        },
        {
          view: "text",
          label: "KODE URUSAN",
          id: "ADD_INDIPROG_URS_ID",
          name: "INDIPROG_URS_ID",
          hidden: true,
          labelWidth: 180
        },
        {
          ...
          id: "ADD_INDIPROG_BID_URS_ID",
          name: "INDIPROG_BID_URS_ID",
          hidden: true,
          labelWidth: 180
        },
        {
          view: "text",
          label: "KODE PROGRAM",
          id: "ADD_INDIPROG_PROG_ID",
          name: "INDIPROG_PROG_ID",
          hidden: true,
          labelWidth: 180
        },
        {
          view: "text",
          label: "KODE PROGRAM FULL",
          id: "ADD_INDIPROG_PRG_FULL",
          name: "INDIPROG_PRG_FULL",
          hidden: true,
          labelWidth: 180
        },
        {
          view: "text",
          label: "STATUS RENSTRA",
          id: "ADD_INDIPROG_STATUS_RENSTRA",
          name: "INDIPROG_STATUS_RENSTRA",
          hidden: true,
          labelWidth: 180
        },
        {
          view: "combo",
          label: "PILIH INDI PROG",
          id: "ADD_INDIPROG_INDIKATOR_PROGRAM1",
          name: "INDIPROG_INDIKATOR_PROGRAM1",
          labelWidth: 180,
          options: [{
            id: "",
            value: ""
        ...
        },
        {
          ...
          id: "ADD_INDIPROG_INDIKATOR_PROGRAM",
          name: "INDIPROG_INDIKATOR_PROGRAM",
          labelWidth: 180
        },
        {
          view: "text",
          label: "SATUAN INDIKATOR",
          id: "ADD_INDIPROG_SATUAN_INDIKATOR_PROGRAM",
          name: "INDIPROG_SATUAN_INDIKATOR_PROGRAM",
          labelWidth: 180
        },
        {
          view: "text",
          label: "KINERJA AWAL",
          id: "ADD_INDIPROG_KINERJA_AWAL_PROGRAM",
          name: "INDIPROG_KINERJA_AWAL_PROGRAM",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA AKHIR",
          id: "ADD_INDIPROG_TARGET_AKHIR_KINERJA_PROGRAM",
          name: "INDIPROG_TARGET_AKHIR_KINERJA_PROGRAM",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-1",
          id: "ADD_INDIPROG_TARGET_KINERJA_PROG_TAHUN1",
          name: "INDIPROG_TARGET_KINERJA_PROG_TAHUN1",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-2",
          id: "ADD_INDIPROG_TARGET_KINERJA_PROG_TAHUN2",
          name: "INDIPROG_TARGET_KINERJA_PROG_TAHUN2",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-3",
          id: "ADD_INDIPROG_TARGET_KINERJA_PROG_TAHUN3",
          name: "INDIPROG_TARGET_KINERJA_PROG_TAHUN3",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-4",
          id: "ADD_INDIPROG_TARGET_KINERJA_PROG_TAHUN4",
          name: "INDIPROG_TARGET_KINERJA_PROG_TAHUN4",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-5",
          id: "ADD_INDIPROG_TARGET_KINERJA_PROG_TAHUN5",
          name: "INDIPROG_TARGET_KINERJA_PROG_TAHUN5",
          labelWidth: 180
        },
        {
          view: "textarea",
          label: "CATATAN REJECT",
          id: "ADD_INDIPROG_CATATAN_REJECT",
          name: "INDIPROG_CATATAN_REJECT",
          labelWidth: 180,
          disabled: true
        },
        {
    ...
    var FORM_DATA2_ADD = {
      ...
      elements: [{
          ...
          id: "ADD_KEG_STATUS_RENSTRA",
          name: "KEG_STATUS_RENSTRA",
          labelWidth: 180,
          hidden: true
        },
        {
        ...
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-1",
          id: "ADD_KEG_TARGET_PAGU_KEG_TAHUN1",
          name: "KEG_TARGET_PAGU_KEG_TAHUN1",
          labelWidth: 180,
          disabled: true
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-2",
          id: "ADD_KEG_TARGET_PAGU_KEG_TAHUN2",
          name: "KEG_TARGET_PAGU_KEG_TAHUN2",
          labelWidth: 180,
          disabled: true
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-3",
          id: "ADD_KEG_TARGET_PAGU_KEG_TAHUN3",
          name: "KEG_TARGET_PAGU_KEG_TAHUN3",
          labelWidth: 180,
          disabled: true
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-4",
          id: "ADD_KEG_TARGET_PAGU_KEG_TAHUN4",
          name: "KEG_TARGET_PAGU_KEG_TAHUN4",
          labelWidth: 180,
          disabled: true
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-5",
          id: "ADD_KEG_TARGET_PAGU_KEG_TAHUN5",
          name: "KEG_TARGET_PAGU_KEG_TAHUN5",
          labelWidth: 180,
          disabled: true
        },
        {
    ...
    var FORM_DATA21_ADD = {
      ...
      elements: [{
          view: "text",
          label: "STATUS RENSTRA",
          id: "INDIKEG_STATUS_RENSTRA",
          name: "INDIKEG_STATUS_RENSTRA",
          labelWidth: 180,
          hidden: true
        },
        {
        ...
        },
        {
          view: "text",
          label: "SUB OPD",
          id: "ADD_INDIKEG_SUB_OPD_ID",
          name: "INDIKEG_SUB_OPD_ID",
          labelWidth: 180,
          hidden: true
        },
        {
          view: "combo",
          label: "KEG FULL",
          id: "ADD_INDIKEG_KEG_FULL",
          name: "INDIKEG_KEG_FULL",
          labelWidth: 180,
          option: [{
            id: "Admin",
            value: ""
        ...
        {
          view: "combo",
          label: "PILIH INDI KEG",
          id: "ADD_INDIKEG_INDIKATOR_KEGIATAN1",
          name: "INDIKEG_INDIKATOR_KEGIATAN1",
          labelWidth: 180,
          options: [{
            id: "",
            value: ""
        ...
        },
        {
          ...
          id: "ADD_INDIKEG_INDIKATOR_KEGIATAN",
          name: "INDIKEG_INDIKATOR_KEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "SATUAN INDIKATOR",
          id: "ADD_INDIKEG_SATUAN_INDIKATOR_KEGIATAN",
          name: "INDIKEG_SATUAN_INDIKATOR_KEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "KINERJA AWAL",
          id: "ADD_INDIKEG_KINERJA_AWAL_KEGIATAN",
          name: "INDIKEG_KINERJA_AWAL_KEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA AKHIR",
          id: "ADD_INDIKEG_TARGET_AKHIR_KINERJA_KEGIATAN",
          name: "INDIKEG_TARGET_AKHIR_KINERJA_KEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-1",
          id: "ADD_INDIKEG_TARGET_KINERJA_KEG_TAHUN1",
          name: "INDIKEG_TARGET_KINERJA_KEG_TAHUN1",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-2",
          id: "ADD_INDIKEG_TARGET_KINERJA_KEG_TAHUN2",
          name: "INDIKEG_TARGET_KINERJA_KEG_TAHUN2",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-3",
          id: "ADD_INDIKEG_TARGET_KINERJA_KEG_TAHUN3",
          name: "INDIKEG_TARGET_KINERJA_KEG_TAHUN3",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-4",
          id: "ADD_INDIKEG_TARGET_KINERJA_KEG_TAHUN4",
          name: "INDIKEG_TARGET_KINERJA_KEG_TAHUN4",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-5",
          id: "ADD_INDIKEG_TARGET_KINERJA_KEG_TAHUN5",
          name: "INDIKEG_TARGET_KINERJA_KEG_TAHUN5",
          labelWidth: 180
        },
        {
          view: "textarea",
          label: "CATATAN REJECT",
          id: "ADD_INDIKEG_CATATAN_REJECT",
          name: "ADD_INDIKEG_CATATAN_REJECT",
          labelWidth: 180,
          disabled: true
        },
        {
    ...
    var FORM_DATA3_ADD = {
      ...
      elements: [
        ...
        },
        {
          view: "text",
          label: "SUB OPD",
          id: "ADD_SUBKEG_SUB_OPD_ID",
          name: "SUBKEG_SUB_OPD_ID",
          labelWidth: 180,
          hidden: true
        },
        {
          view: "text",
          label: "BIDANG",
          id: "ADD_SUBKEG_BIDANG_OPD_ID",
          name: "SUBKEG_BIDANG_OPD_ID",
          labelWidth: 180,
          hidden: true
        },
        {
          view: "text",
          label: "DESKRIPSI",
          id: "ADD_SUBKEG_DESKRIPSI",
          name: "SUBKEG_DESKRIPSI",
          labelWidth: 180,
          hidden: true
        },
        ...
        // {view:"richselect", label:"KEGIATAN", id:"3KEGIATAN", labelWidth:180, options:[{id:"Admin", value:""},{id:"", value:""},]},
        {
          view: "combo",
          label: "SUB KEGIATAN",
          id: "ADD_SUBKEG_SUBKEG_FULL",
          name: "SUBKEG_SUBKEG_FULL",
          labelWidth: 180,
          options: [{
            id: "Admin",
            value: ""
        ...
        // {view:"text", label:"TOTAL PAGU AKHIR PERIODE",	id:"3TOTAL PAGU", 				labelWidth:180},
        {
          view: "text",
          label: "PAGU TAHUN KE-1",
          id: "ADD_SUBKEG_TARGET_PAGU_SUBKEG_TAHUN1",
          name: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN1",
          labelWidth: 180
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-2",
          id: "ADD_SUBKEG_TARGET_PAGU_SUBKEG_TAHUN2",
          name: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN2",
          labelWidth: 180
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-3",
          id: "ADD_SUBKEG_TARGET_PAGU_SUBKEG_TAHUN3",
          name: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN3",
          labelWidth: 180
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-4",
          id: "ADD_SUBKEG_TARGET_PAGU_SUBKEG_TAHUN4",
          name: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN4",
          labelWidth: 180
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-5",
          id: "ADD_SUBKEG_TARGET_PAGU_SUBKEG_TAHUN5",
          name: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN5",
          labelWidth: 180
        },
        {
          margin: 5,
    ...
    var FORM_DATA31_ADD = {
      ...
      elements: [

        {
          view: "text",
          label: "STATUS RENSTRA",
          id: "ADD_INDISUBKEG_PROSES_RENSTRA",
          name: "INDISUBKEG_PROSES_RENSTRA",
          labelWidth: 180,
          hidden: true
        },
        {
          view: "text",
          label: "PRTID",
          id: "ADD_INDISUBKEG_PRT_ID",
          name: "INDISUBKEG_PRT_ID",
          labelWidth: 180,
          hidden: true
        },
        {
          view: "text",
          label: "OPD",
          id: "ADD_INDISUBKEG_OPD_ID",
          name: "INDISUBKEG_OPD_ID",
          labelWidth: 180,
          hidden: true
        },
        {
          view: "text",
          label: "SUB OPD",
          id: "ADD_INDISUBKEG_SUB_OPD_ID",
          name: "INDISUBKEG_SUB_OPD_ID",
          labelWidth: 180,
          hidden: true
        },
        // {view:"combo", label:"KEG FULL", id:"ADD_INDIKEG_KEG_FULL", 	name:"INDIKEG_KEG_FULL" ,	labelWidth:180, option:[{id:"Admin", value:""},{id:"", value:""},],disabled:true},
        {
          ...
          id: "ADD_INDISUBKEG_INDIKATOR_SUBKEGIATAN",
          name: "INDISUBKEG_INDIKATOR_SUBKEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "SATUAN INDIKATOR",
          id: "ADD_INDISUBKEG_SATUAN_INDIKATOR_SUBKEGIATAN",
          name: "INDISUBKEG_SATUAN_INDIKATOR_SUBKEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "KINERJA AWAL",
          id: "ADD_INDISUBKEG_KINERJA_AWAL_SUBKEGIATAN",
          name: "INDISUBKEG_KINERJA_AWAL_SUBKEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA AKHIR",
          id: "ADD_INDISUBKEG_TARGET_AKHIR_KINERJA_SUBKEGIATAN",
          name: "INDISUBKEG_TARGET_AKHIR_KINERJA_SUBKEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-1",
          id: "ADD_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN1",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN1",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-2",
          id: "ADD_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN2",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN2",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-3",
          id: "ADD_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN3",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN3",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-4",
          id: "ADD_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN4",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN4",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-5",
          id: "ADD_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN5",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN5",
          labelWidth: 180
        },
        {
          view: "textarea",
          label: "CATATAN REJECT",
          id: "ADD_INDISUBKEG_CATATAN_REJECT",
          name: "INDISUBKEG_CATATAN_REJECT",
          labelWidth: 180,
          disabled: true
        },
        {
    ...
    var FORM_DATA11_EDIT = {
      ...
      elements: [{
          view: "combo",
          label: "PILIH INDI PROG",
          id: "INDIPROG_INDIKATOR_PROGRAM1",
          name: "INDIPROG_INDIKATOR_PROGRAM1",
          labelWidth: 180,
          options: [{
            id: "",
    ...
    var FORM_DATA2_EDIT = {
      ...
      elements: [
        ...
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-5",
          iid: "KEG_TARGET_PAGU_KEG_TAHUN5",
          name: "KEG_TARGET_PAGU_KEG_TAHUN5",
          labelWidth: 180,
          disabled: true
        },
        {
          view: "textarea",
          label: "CATATAN REJECT",
          id: "KEG_CATATAN_REJECT",
          name: "KEG_CATATAN_REJECT",
          labelWidth: 180,
          disabled: true
        },
        {
    ...
    var FORM_DATA21_EDIT = {
      ...
      elements: [{
          view: "combo",
          label: "PILIH INDI PROG",
          id: "INDIKEG_INDIKATOR_KEGIATAN1",
          name: "INDIKEG_INDIKATOR_KEGIATAN1",
          labelWidth: 180,
          options: [{
            id: "",
        ...
        },
        {
          view: "text",
          label: "TARGET KINERJA AKHIR",
          id: "INDIKEG_TARGET_AKHIR_KINERJA_PROGRAM",
          name: "INDIKEG_TARGET_AKHIR_KINERJA_KEGIATAN",
          labelWidth: 180
        },
        {
    ...
    var FORM_DATA3_EDIT = {
      ...
      elements: [
        ...
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-5",
          iid: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN5",
          name: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN5",
          labelWidth: 180,
          disabled: false
        },
    ...
    var FORM_DATA31_EDIT = {
      ...
      elements: [{
          view: "text",
          label: "STATUS RENSTRA",
          id: "EDIT_INDISUBKEG_PROSES_RENSTRA",
          name: "INDISUBKEG_PROSES_RENSTRA",
          labelWidth: 180,
          hidden: true
        },
        ...
        // {view:"combo", label:"KEG FULL", id:"ADD_INDIKEG_KEG_FULL", 	name:"INDIKEG_KEG_FULL" ,	labelWidth:180, option:[{id:"Admin", value:""},{id:"", value:""},],disabled:true},
        {
          view: "textarea",
          label: "INDIKATOR SUB KEGIATAN",
          id: "EDIT_INDISUBKEG_INDIKATOR_SUBKEGIATAN",
          name: "INDISUBKEG_INDIKATOR_SUBKEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "SATUAN INDIKATOR",
          id: "EDIT_INDISUBKEG_SATUAN_INDIKATOR_SUBKEGIATAN",
          name: "INDISUBKEG_SATUAN_INDIKATOR_SUBKEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "KINERJA AWAL",
          id: "EDIT_INDISUBKEG_KINERJA_AWAL_SUBKEGIATAN",
          name: "INDISUBKEG_KINERJA_AWAL_SUBKEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA AKHIR",
          id: "EDIT_INDISUBKEG_TARGET_AKHIR_KINERJA_SUBKEGIATAN",
          name: "INDISUBKEG_TARGET_AKHIR_KINERJA_SUBKEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-1",
          id: "EDIT_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN1",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN1",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-2",
          id: "EDIT_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN2",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN2",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-3",
          id: "EDIT_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN3",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN3",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-4",
          id: "EDIT_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN4",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN4",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-5",
          id: "EDIT_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN5",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN5",
          labelWidth: 180
        },
        {
          view: "textarea",
          label: "CATATAN REJECT",
          id: "EDIT_INDISUBKEG_CATATAN_REJECT",
          name: "INDISUBKEG_CATATAN_REJECT",
          labelWidth: 180,
          disabled: true
        },
    ...
    var FORM_DATA1_DELETE = {
      ...
      elements: [
        ...
        // {view:"text", 			label:"TOTAL PAGU AKHIR PERIODE",	id:"DELETE_ARGET_AKHIR_PAGU_PROGRAMU", 				labelWidth:180},
        {
          view: "text",
          label: "PAGU TAHUN KE-1",
          id: "DELETE_TARGET_PAGU_PROG_TAHUN1",
          name: "TARGET_PAGU_PROG_TAHUN1",
          labelWidth: 180
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-2",
          id: "DELETE_TARGET_PAGU_PROG_TAHUN2",
          name: "TARGET_PAGU_PROG_TAHUN2",
          labelWidth: 180
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-3",
          id: "DELETE_TARGET_PAGU_PROG_TAHUN3",
          name: "TARGET_PAGU_PROG_TAHUN3",
          labelWidth: 180
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-4",
          id: "DELETE_TARGET_PAGU_PROG_TAHUN4",
          name: "TARGET_PAGU_PROG_TAHUN4",
          labelWidth: 180
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-5",
          id: "DELETE_TARGET_PAGU_PROG_TAHUN5",
          name: "TARGET_PAGU_PROG_TAHUN5",
          labelWidth: 180
        },
        {
    ...
    var FORM_DATA11_DELETE = {
      ...
      elements: [

        {
          view: "textarea",
          label: "INDIKATOR PROGRAM",
          id: "DEL_INDIPROG_INDIKATOR_PROGRAM",
          name: "INDIPROG_INDIKATOR_PROGRAM",
          labelWidth: 180
        },
        {
          view: "text",
          label: "SATUAN INDIKATOR",
          id: "DEL_INDIPROG_SATUAN_INDIKATOR_PROGRAM",
          name: "INDIPROG_SATUAN_INDIKATOR_PROGRAM",
          labelWidth: 180
        },
        {
          view: "text",
          label: "KINERJA AWAL",
          id: "DEL_INDIPROG_KINERJA_AWAL_PROGRAM",
          name: "INDIPROG_KINERJA_AWAL_PROGRAM",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA AKHIR",
          id: "DEL_INDIPROG_TARGET_AKHIR_KINERJA_PROGRAM",
          name: "INDIPROG_TARGET_AKHIR_KINERJA_PROGRAM",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-1",
          id: "DEL_INDIPROG_TARGET_KINERJA_PROG_TAHUN1",
          name: "INDIPROG_TARGET_KINERJA_PROG_TAHUN1",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-2",
          id: "DEL_INDIPROG_TARGET_KINERJA_PROG_TAHUN2",
          name: "INDIPROG_TARGET_KINERJA_PROG_TAHUN2",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-3",
          id: "DEL_INDIPROG_TARGET_KINERJA_PROG_TAHUN3",
          name: "INDIPROG_TARGET_KINERJA_PROG_TAHUN3",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-4",
          id: "DEL_INDIPROG_TARGET_KINERJA_PROG_TAHUN4",
          name: "INDIPROG_TARGET_KINERJA_PROG_TAHUN4",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-5",
          id: "DEL_INDIPROG_TARGET_KINERJA_PROG_TAHUN5",
          name: "INDIPROG_TARGET_KINERJA_PROG_TAHUN5",
          labelWidth: 180
        },
        {
          view: "textarea",
          label: "CATATAN REJECT",
          id: "DEL_INDIPROG_CATATAN_REJECT",
          name: "INDIPROG_CATATAN_REJECT",
          labelWidth: 180,
          disabled: true
        },
    ...
    var FORM_DATA2_DELETE = {
      ...
      elements: [
        ...
        // {view:"text", 			label:"TOTAL PAGU AKHIR PERIODE",	id:"2E-TOTAL PAGU", 				labelWidth:180},
        {
          view: "text",
          label: "PAGU TAHUN KE-1",
          id: "DEL_KEG_TARGET_PAGU_KEG_TAHUN1",
          name: "KEG_TARGET_PAGU_KEG_TAHUN1",
          labelWidth: 180,
          disabled: true
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-2",
          id: "DEL_KEG_TARGET_PAGU_KEG_TAHUN2",
          name: "KEG_TARGET_PAGU_KEG_TAHUN2",
          labelWidth: 180,
          disabled: true
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-3",
          id: "DEL_KEG_TARGET_PAGU_KEG_TAHUN3",
          name: "KEG_TARGET_PAGU_KEG_TAHUN3",
          labelWidth: 180,
          disabled: true
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-4",
          id: "DEL_KEG_TARGET_PAGU_KEG_TAHUN4",
          name: "KEG_TARGET_PAGU_KEG_TAHUN4",
          labelWidth: 180,
          disabled: true
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-5",
          iid: "DEL_KEG_TARGET_PAGU_KEG_TAHUN5",
          name: "KEG_TARGET_PAGU_KEG_TAHUN5",
          labelWidth: 180,
          disabled: true
        },
    ...
    var FORM_DATA21_DELETE = {
      ...
      elements: [

        {
          view: "textarea",
          label: "INDIKATOR KEGIATAN",
          id: "DEL_INDIKEG_INDIKATOR_KEGIATAN",
          name: "INDIKEG_INDIKATOR_KEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "SATUAN INDIKATOR",
          id: "DEL_INDIKEG_SATUAN_INDIKATOR_KEGIATAN",
          name: "INDIKEG_SATUAN_INDIKATOR_KEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "KINERJA AWAL",
          id: "DEL_INDIKEG_KINERJA_AWAL_KEGIATAN",
          name: "INDIKEG_KINERJA_AWAL_KEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA AKHIR",
          id: "DEL_INDIKEG_TARGET_AKHIR_KINERJA_PROGRAM",
          name: "INDIKEG_TARGET_AKHIR_KINERJA_KEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-1",
          id: "DEL_INDIKEG_TARGET_KINERJA_KEG_TAHUN1",
          name: "INDIKEG_TARGET_KINERJA_KEG_TAHUN1",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-2",
          id: "DEL_INDIKEG_TARGET_KINERJA_KEG_TAHUN2",
          name: "INDIKEG_TARGET_KINERJA_KEG_TAHUN2",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-3",
          id: "DEL_INDIKEG_TARGET_KINERJA_KEG_TAHUN3",
          name: "INDIKEG_TARGET_KINERJA_KEG_TAHUN3",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-4",
          id: "DEL_INDIKEG_TARGET_KINERJA_KEG_TAHUN4",
          name: "INDIKEG_TARGET_KINERJA_KEG_TAHUN4",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-5",
          id: "DEL_INDIKEG_TARGET_KINERJA_KEG_TAHUN5",
          name: "INDIKEG_TARGET_KINERJA_KEG_TAHUN5",
          labelWidth: 180
        },
        {
    ...
    var FORM_DATA3_DELETE = {
      ...
      elements: [
        ...
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-1",
          id: "DEL_SUBKEG_TARGET_PAGU_SUBKEG_TAHUN1",
          name: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN1",
          labelWidth: 180,
          disabled: false
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-2",
          id: "DEL_SUBKEG_TARGET_PAGU_SUBKEG_TAHUN2",
          name: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN2",
          labelWidth: 180,
          disabled: false
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-3",
          id: "DEL_SUBKEG_TARGET_PAGU_SUBKEG_TAHUN3",
          name: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN3",
          labelWidth: 180,
          disabled: false
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-4",
          id: "DEL_SUBKEG_TARGET_PAGU_SUBKEG_TAHUN4",
          name: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN4",
          labelWidth: 180,
          disabled: false
        },
        {
          view: "text",
          label: "PAGU TAHUN KE-5",
          iid: "DEL_SUBKEG_TARGET_PAGU_SUBKEG_TAHUN5",
          name: "SUBKEG_TARGET_PAGU_SUBKEG_TAHUN5",
          labelWidth: 180,
          disabled: false
        },
    ...
    var FORM_DATA31_DELETE = {
      ...
      elements: [

        {
          view: "text",
          label: "STATUS RENSTRA",
          id: "DEL_INDISUBKEG_PROSES_RENSTRA",
          name: "INDISUBKEG_PROSES_RENSTRA",
          labelWidth: 180,
          hidden: true
        },
        ...
        // {view:"combo", label:"KEG FULL", id:"ADD_INDIKEG_KEG_FULL", 	name:"INDIKEG_KEG_FULL" ,	labelWidth:180, option:[{id:"Admin", value:""},{id:"", value:""},],disabled:true},
        {
          view: "textarea",
          label: "INDIKATOR SUB KEGIATAN",
          id: "DEL_INDISUBKEG_INDIKATOR_SUBKEGIATAN",
          name: "INDISUBKEG_INDIKATOR_SUBKEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "SATUAN INDIKATOR",
          id: "DEL_INDISUBKEG_SATUAN_INDIKATOR_SUBKEGIATAN",
          name: "INDISUBKEG_SATUAN_INDIKATOR_SUBKEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "KINERJA AWAL",
          id: "DEL_INDISUBKEG_KINERJA_AWAL_SUBKEGIATAN",
          name: "INDISUBKEG_KINERJA_AWAL_SUBKEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA AKHIR",
          id: "DEL_INDISUBKEG_TARGET_AKHIR_KINERJA_SUBKEGIATAN",
          name: "INDISUBKEG_TARGET_AKHIR_KINERJA_SUBKEGIATAN",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-1",
          id: "DEL_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN1",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN1",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-2",
          id: "DEL_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN2",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN2",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-3",
          id: "DEL_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN3",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN3",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-4",
          id: "DEL_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN4",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN4",
          labelWidth: 180
        },
        {
          view: "text",
          label: "TARGET KINERJA TAHUN KE-5",
          id: "DEL_INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN5",
          name: "INDISUBKEG_TARGET_KINERJA_SUBKEG_TAHUN5",
          labelWidth: 180
        },
        {
          view: "textarea",
          label: "CATATAN REJECT",
          id: "DEL_INDISUBKEG_CATATAN_REJECT",
          name: "INDISUBKEG_CATATAN_REJECT",
          labelWidth: 180,
          disabled: true
        },
    ...
    function getData() {
      ...
      if ($$("SASARAN_PD_CB").getValue() == 0) {
        SASARAN_PD_TXT = "";
      }
      if ($$("OPD_CB").getValue() == 0) {
        OPD_TXT = "";
      }
      if ($$("SUB_OPD_CB").getValue() == 0) {
        SUB_OPD_TXT = "";
      }
      if ($$("DESKRIPSI_CB").getValue() == 0) {
        DESKRIPSI_TXT = "";
      }
      if ($$("STATUS_RENSTRA_CB").getValue() == 0) {
        STATUS_RENSTRA_TXT = "";
      }

      var param = "?";
      param += "SASARAN_PD_TXT=" + SASARAN_PD_TXT;
      param += "&";
      param += "OPD_TXT=" + OPD_TXT;
      param += "&";
      param += "SUB_OPD_TXT=" + SUB_OPD_TXT;
      param += "&";
      param += "DESKRIPSI_TXT=" + DESKRIPSI_TXT;
      param += "&";
      param += "STATUS_RENSTRA_TXT=" + STATUS_RENSTRA_TXT;
      param += "&";
      param += "from=" + from;
      param += "&";
      ...
      webix.ajax().post("perencanaan_renstra_entri_murni_data.php" + param + "mode=paging", function(text, data) {
        ...
        if (data.json().status == "success") {
          ...
          if (numr == 0) {
            ...
            $$("DT_PROG").refresh();
            // $.ajax
            // var vv = url("perencanaan_renstra_entri_murni_data.php" + param + "mode=pagingx");

            webix.ajax().post("perencanaan_renstra_entri_murni_data.php" + param + "mode=pagingx",
              function(text, data) {
                // console.log(data);
                // console.log(data.json());
              })
    ...
    function bindProgFormEdit() {
      ...
      // bind indikator
      $$('ADD_INDIPROG_INDIKATOR_PROGRAM').bind('ADD_INDIPROG_INDIKATOR_PROGRAM1');
      // $$('INDIPROG_INDIKATOR_PROGRAM').bind('INDIPROG_INDIKATOR_PROGRAM1');

      // untuk update text di kolom indikator program manual ketika diedit
      $$("INDIPROG_INDIKATOR_PROGRAM1").attachEvent("onChange", function(newv, oldv) {
        // webix.message("Value changed from: "+oldv+" to: "+newv);
        $$("INDIPROG_INDIKATOR_PROGRAM").setValue(newv);
      });

      $$('ADD_INDIKEG_INDIKATOR_KEGIATAN').bind('ADD_INDIKEG_INDIKATOR_KEGIATAN1');

      // untuk update text di kolom indikator kegiatan manual ketika diedit
      $$("INDIKEG_INDIKATOR_KEGIATAN1").attachEvent("onChange", function(newv, oldv) {
        // webix.message("Value changed from: "+oldv+" to: "+newv);
        $$("INDIKEG_INDIKATOR_KEGIATAN").setValue(newv);
      });
    ...
    function dataEdit1() {
      ...
      // console.log(param1)
      webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=program&action=edit&lane=renstra", {
        param1: param1
      }, function(text, data) {
        if (data.json().status == "success") {
          console.log(data.json().status2)
    ...
    function dataDeleteProgram() {
      ...
      // console.log(param1)
      webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=program&action=delete", {
        param1: param1
      }, function(text, data) {
        if (data.json().status == "success") {
          webix.message({
    ...
    function dataEditIndiProg() {
      ...
      if (validasiEditIndikatorProg()) {
        ...
        // console.log(param1)
        webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=indiprog&action=edit", {
          param1: param1
        }, function(text, data) {
          // console.log(data.json().status);
          if (data.json().status == "success") {
        ...
        webix.message({
          type: "error",
          text: "isi data dengan angka saja"
        });
      }
    ...
    function dataAddIndiProg() {
      ...
      if (validasiAddIndikatorProg()) {
        ...
        // param1.INDIPROG_INDIKATOR_PROGRAM1 = $$('ADD_INDIPROG_INDIKATOR_PROGRAM1').getText();
        // console.log();
        // console.log(param1)
        webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=indiprog&action=add", {
          param1: param1
        }, function(text, data) {
          // console.log(data.json());
          if (data.json().status == "success") {
          ...
          } else { //untuk redirect di handle di combo_indikator.php
            webix.alert({
              type: "alert-error",
              title: "INFORMATION",
              text: "Data Tidak Berhasil Ditambahkan !! " + data.json().status,
    ...
    function dataDeleteIndiProgram() {
      ...
      // console.log(param1)
      webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=indiprog&action=delete", {
        param1: param1
      }, function(text, data) {
        // console.log(data.json().status);
        if (data.json().status == "success") {
    ...
    function dataAddKeg() {
      ...
      webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=kegiatan&action=add", {
        param1: param1
      }, function(text, data) {
        // console.log(data.json().status);
        if (data.json().status == "success") {
    ...
    function dataDeleteKegiatan() {
      ...
      console.log(param1)
      webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=kegiatan&action=delete", {
        param1: param1
      }, function(text, data) {
        // console.log(data.json().status);
        if (data.json().status == "success") {
    ...
    function dataEditIndiKeg() {
      ...
      if (validasiIndikatorKeg(param1)) {
        ...
        // console.log(param1)
        webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=indikeg&action=edit", {
          param1: param1
        }, function(text, data) {
          // console.log(data.json().status);
          if (data.json().status == "success") {
    ...
    function dataDeleteIndiKegiatan() {
      ...
      webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=indikeg&action=delete", {
        param1: param1
      }, function(text, data) {
        // console.log(data.json().status);
        if (data.json().status == "success") {
    ...
    function dataAddIndKeg() {
      ...
      if (validasiIndikatorKeg(param1)) {
        ...
        // console.log(param1)
        webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=indikeg&action=add", {
          param1: param1
        }, function(text, data) {
          // console.log(data.json().status);
          if (data.json().status == "success") {
    ...
    function dataAddSubKeg() {
      ...
      if (validasiSubKeg(param1)) {
        webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=subkeg&action=add", {
          param1: param1
        }, function(text, data) {
          console.log(data.json().status);
          if (data.json().status == "success") {
    ...
    function dataEditSubKeg() {
      ...
      if (validasiSubKeg(param1)) {
        webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=subkeg&action=edit", {
          param1: param1
        }, function(text, data) {
          // console.log(data.json().status);
          if (data.json().status == "success") {
    ...
    function dataDeleteSubKegiatan() {
      ...
      webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=subkeg&action=delete", {
        param1: param1
      }, function(text, data) {
        // console.log(data.json().status);
        if (data.json().status == "success") {
    ...
    function dataAddIndSubKeg() {
      ...
      if (validasiIndiSubKeg(param1)) {
        webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=indisubkeg&action=add", {
          param1: param1
        }, function(text, data) {
          // console.log(data.json().status);
          if (data.json().status == "success") {
            ...
            $$("DT_INDI_SUB_KEG").load(function() {
              return webix.ajax().post("perencanaan_renstra_entri_murni_data_child.php?lvl=indisubkeg", {
                rowid: param1.INDISUBKEG_PRT_ID
              }, function(text, data) {})
            });
            // getData();
          } else if (data.json().status == "bermasalah") {
    ...
    function dataEditIndSubKeg() {
      ...
      if (validasiIndiSubKeg(param1)) {
        webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=indisubkeg&action=edit", {
          param1: param1
        }, function(text, data) {
          // console.log(data.json().status);
          if (data.json().status == "success") {
    ...
    function dataDeleteIndSubKeg() {
      ...
      webix.ajax().post("perencanaan_renstra_entri_murni_data_crud_program.php?lvl=indisubkeg&action=delete", {
        param1: param1
      }, function(text, data) {
        // console.log(data.json().status);
        if (data.json().status == "success") {
    ...
    function pengajuan() {
      ...
      if (webix.rules.isNotEmpty(param1.ROW_ID)) {
        ...
        webix.ajax().post("getStatus.php?lvl=program_renstra_murni&opd_id=" + param1.OPD_ID, function(text, data) {
          console.log(data.json().status);
          if (data.json().status == "reject") {

            webix.ajax().post("verifikasi.php?lvl=renstra_kabid&action=pengajuan", {
              param1: param1
            }, function(text, data) {
              // console.log(data.json().status);
              if (data.json().status == "success") {
                webix.message({
                  type: "form",
                  text: "<div style='background-color:#24c066; color:#fff; margin:-6px -11px -6px -11px;'><span class='webix_icon fa-check-square-o'></span>Proses Pengajuan Berhasil.</div>"
                });
                // console.log("add program");
                // console.log(data.json().action);
                // console.log(data.json().sqltes);			
                ...
                webix.alert({
                  type: "alert-error",
                  title: "INFORMATION",
                  text: "Proses Pengajuan Gagal !! Karena Status " + data.json().status,
                  ok: "OK",
                  callback: function() {
                    // $$("WIN_DATA11_ADD").hide();
                  }
