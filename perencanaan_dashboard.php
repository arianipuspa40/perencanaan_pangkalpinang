...
<head>
	...
	<title>:: PERENCANAAN - KABUPATEN TANA TIDUNG ::</title>
...
var jumlah_chart = {
	...
	rows: [
		...
		// {view:"label", label:"<img class='photo' src='img/logo_156ktt.png' />", autowidth:true
			// view:"chart",
			// type:"stackedBarH",
			// barWidth:35,
			// xAxis:{},
...
var tabel = {
	...
	rows: [
		{
			template: "<span class='webix_icon fa-tasks'></span>KETERKAITAN VISI MISI, TUJUAN DAN SASARAN RPJMD",
			css: "sub_title",
			height: 30
		}, 
		{
		...
		rows:[
			{
				...
				elements:[
					{view:"label", template:
						...
						"<span class='webix_icon fa-angle-double-right'></span>DASHBOARD"
					},
				],
			},
			{
