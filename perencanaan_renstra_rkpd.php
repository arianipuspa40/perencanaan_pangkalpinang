	...
	webix.ui({
		...
		rows:[
				...
				elements:[
					...
					{ view:"segmented", value:"MURNI", width:300, 
						...
						//{id:"SASARAN PD", value:"SASARAN PD"}
							...
							if (id_opt=="MURNI") {$$("IFRAME_CONTENT").load("perencanaan_renstra_rkpd_murni.php");}
							if (id_opt=="PERUBAHAN") {$$("IFRAME_CONTENT").load("perencanaan_renstra_rkpd_perubahan.php");}
			...
			},
			{
				//type:"space",
				rows:[
					{view:"iframe", padding:0, id:"IFRAME_CONTENT", autoheight:true, adjust:true, scroll:"auto", src:"perencanaan_renstra_rkpd_murni.php"}
				]
			}
		]
	});
