		...
		rows: [
			{
				...
				elements:[
					{ view:"segmented", value:"MURNI", width: 370, 
						options:[
						{id:"MURNI", value:"MURNI"},
						{id:"PERUBAHAN", value:"PERUBAHAN"},
						], click: function(id, e) {
							var id_opt = $$(id).getValue();
							if (id_opt=="MURNI") {$$("IFRAME_CONTENT").load("sasaran_daerah_murni.php");}
							if (id_opt=="PERUBAHAN") {$$("IFRAME_CONTENT").load("sasaran_daerah_perubahan.php");}
						}
					},
					{},
				],
			...
			{
				rows: [
					{view:"iframe", padding:0, id:"IFRAME_CONTENT", autoheight:true, adjust:true, scroll:"auto", src: "sasaran_daerah_murni.php"}
				]
			}
		]
	});
