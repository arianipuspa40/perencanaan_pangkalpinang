...
<body>
  ...
  <script type="text/javascript">
    ...
    var nav_sasaran_daerah = {
      ...
      height: 35,
      cols: [{
          template: "<span class='webix_icon fa-table'></span>TUJUAN PD",
          css: "sub_title2",
          borderless: true
        },
        {
    ...
    webix.ready(function() {
      ...
      $$("DT_TUJUAN").load("perencanaan_data_tujuan_opd.php");
      $$('filter_tujuan').bind('DT_TUJUAN');
      $$('FORM_EDIT').bind('DT_TUJUAN');
      $$('FORM_DELETE').bind('DT_TUJUAN');
    });
    ...
    function addData() {
      ...
      webix.ajax().post("perencanaan_crud_tujuan_sasaran_pd.php?lvl=tujuan&action=add", {
        param1: param1
      }, function(text, data) {
    ...
    function showEditData() {
      ...
      if ($$("FORM_EDIT").getValues().TUJUAN_ROW_ID > 0) {
    ...
    function editData() {
      ...
      webix.ajax().post("perencanaan_crud_tujuan_sasaran_pd.php?lvl=tujuan&action=edit", {
        param1: param1
      }, function(text, data) {
        if (data.json().status == "success") {
          webix.message({
    ...
    function showDeleteData() {
      showWindow("WIN_DATA_DELETE");
      // console.log($$("FORM_EDIT").getValues());
      if ($$("FORM_DELETE").getValues().TUJUAN_ROW_ID > 0) {
    ...
    function deleteData() {
      ...
      console.log(param1);
      webix.ajax().post("perencanaan_crud_tujuan_sasaran_pd.php?lvl=tujuan&action=delete", {
        param1: param1
      }, function(text, data) {
        if (data.json().status == "success") {
          webix.message({
