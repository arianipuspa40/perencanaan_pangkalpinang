		...
		webix.ui({
			rows:[
				{ view:"toolbar", padding:3, height:50, elements:[
					...
					{view:"label", label:"MONEV - PEMERINTAHAN KOTA PANGKALPINANG - PERENCANAAN", width:500},
					{autowidth:true},
					...
					{view:"button", type:"icon", autowidth:true, css:"app_button", icon:"sign-in", label:"LOGIN", click:"location.href='perencanaan_login.php';"},
				]},
				{ cols:[
					{ rows:[
						{view:"iframe", padding:0, id:"IFRAME_CONTENT", autoheight:true, adjust:true, scroll:"auto", src: "perencanaan_publik_content.php"}
					]}
				]}
			]
		});
