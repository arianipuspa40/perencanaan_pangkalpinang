		...
		rows:[
			{
				...
				elements:[
					{view:"label", template:
						...
						"<span class='webix_icon fa-angle-double-right'></span>RENJA &nbsp;"+
					...
					{ view:"segmented", value:"MURNI", width:300, 
						...
						//{id:"SASARAN PD", value:"SASARAN PD"}
							...
							if (id_opt=="MURNI") {$$("IFRAME_CONTENT").load("perencanaan_renja_bidang_perencanaan_murni.php");}
							if (id_opt=="PERUBAHAN") {$$("IFRAME_CONTENT").load("perencanaan_renja_bidang_perencanaan_perubahan.php");}
			...
			},
			{
				//type:"space",
				rows:[
					{view:"iframe", padding:0, id:"IFRAME_CONTENT", autoheight:true, adjust:true, scroll:"auto", src:"perencanaan_renja_bidang_perencanaan_murni.php"}
				]
			}
		]
	});
